<?php 
	...
	$consulta = "SELECT * FROM cliente"; /* consulta no mysql */
...
<BODY>
	<DIV class="container"> 
		...
		<NAV class="menu"> <!-- Lateral esquerda -->
			<center>
				<br> <br> <br> <br> <a href="registrocliente.php"> <button class="botn info"> Inserir </button> </a>
			</center>
		</NAV>
	...
	<DIV class="meio">
		...
		<tr>
			...
			<td> <a href="cliente_editar.php?codigo="> Editar </a> </td>
		</tr>
		<?php }	?>
		</table>
		</center>
